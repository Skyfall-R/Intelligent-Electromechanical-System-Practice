 ...
 * @param mode 衰减模式
 */
void DRV8833_1_SetDecayMode(DecayMode mode);

/**
 * @brief 设置衰减模式
 * @param mode 衰减模式
 */
void DRV8833_2_SetDecayMode(DecayMode mode);

/**
 * @brief 设置衰减模式
 * @param mode 衰减模式
 */
void DRV8833_3_SetDecayMode(DecayMode mode);

/**
 * @brief 设置衰减模式
 * @param mode 衰减模式
 */
void DRV8833_4_SetDecayMode(DecayMode mode);
